...
user8 = User.new(email:"eugenie@nomail.com", name: "Eugénie", password: "coucou", description: "L’amour c’est comme le jardinage, ça commence par une pelle et ça finit par un râteau.", age:29, height: "170", smoker: false,  drinker: true, sex: "Femme", sexual_orientation: "bi", position: "16 Villa Gaudelet, 75011 Paris")
